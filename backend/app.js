...
const io = new Server(server, {
    cors: {
        origin: ["http://localhost:5173","https://onlinebookstore01.netlify.app"], // Replace with your frontend URL
        methods: ["GET", "POST"],
        credentials: true
    }
});
app.use(cors({
    origin:["http://localhost:5173","https://onlinebookstore01.netlify.app"],
    credentials: true,
    methods: ["GET", "POST"],
}))
